            ...
            new HtmlChecker(helpers.options({excludedKeywords: [conn.absoluteUrls[0]]}), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(junkResults[0]).to.be.like({
                        broken: null, excluded: true, excludedReason: "BLC_KEYWORD"
                    });

                    expect(results).to.have.length(1);
                    expect(results[0]).to.be.like({
                        broken: false, excluded: false, excludedReason: null
                    });
        ...
        it("excludedSchemes = []", function (done)
        {
            ...
            new HtmlChecker(helpers.options({excludedSchemes: []}), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(results).to.all.be.like({
                        broken: true, brokenReason: "BLC_INVALID"
                    });
                    done();
                }
            }).scan(htmlString, baseUrl);
            ...
            new HtmlChecker(helpers.options(), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(junkResults).to.all.be.like({
                        broken: null, brokenReason: null, excluded: true, excludedReason: "BLC_SCHEME"
                    });
                    done();
                }
            }).scan(htmlString, baseUrl);
            ...
            new HtmlChecker(helpers.options(), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(results).to.be.like([{
                        excluded: false, excludedReason: null, internal: true
                    }, {
                        excluded: false, excludedReason: null, internal: false
                    }]);
                    done();
                }
            }).scan(htmlString, baseUrl);
        ...
        it("excludeExternalLinks = true", function (done)
        {
            ...
            new HtmlChecker(helpers.options({excludeExternalLinks: true}), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(results).to.have.length(1);
                    expect(results[0]).to.be.like({
                        html: {text: "link1"}, broken: false, excluded: false, excludedReason: null, internal: true
                    });
        ...
        it("excludeInternalLinks = false", function (done)
        {
            ...
            new HtmlChecker(helpers.options(), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(results).to.all.be.like({
                        broken: false, excluded: false, excludedReason: null, internal: true
                    });
                    done();
                }
            }).scan(htmlString, baseUrl);
        ...
        it("excludeInternalLinks = true", function (done)
        {
            ...
            new HtmlChecker(helpers.options({excludeInternalLinks: true}), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(junkResults).to.all.be.like({
                        broken: null, excluded: true, excludedReason: "BLC_INTERNAL", internal: true
                    });
                    done();
                }
            }).scan(htmlString, baseUrl);
        ...
        it("excludeLinksToSamePage = false", function (done)
        {
            ...
            new HtmlChecker(helpers.options(), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(results).to.be.like([{
                        broken: false, excluded: false, excludedReason: null, internal: true, samePage: true
                    }, {
                        broken: false, excluded: false, excludedReason: null, internal: true, samePage: false
                    }, {
                        broken: false, excluded: false, excludedReason: null, internal: true, samePage: false
                    }, {
                        broken: false, excluded: false, excludedReason: null, internal: true, samePage: true
        ...
        it("filterLevel = 0", function (done)
        {
            ...
            new HtmlChecker(helpers.options({filterLevel: 0}), {
                ...
                }, complete: function ()
                {
                    ...
                    expect(junkResults).to.all.be.like({
                        broken: null, excluded: true, excludedReason: "BLC_HTML"
                    });
