...
function generateData()
{
    ...
    for (url in urls)
    {
        for (base in urls)
        {
            ...
            {
                output[url.toUpperCase() + " url" + " with " + helpers.a_an(base) + " " + base.toUpperCase() + " base" + " and " + htmlBase.toUpperCase() + " html base"] = {
                    linkUrl: urls[url], baseUrl: urls[base], htmlBaseUrl: urls[htmlBase],

                    skipOrOnly: "skip", resolvedLinkUrl: "", resolvedBaseUrl: "", internal: null, samePage: null
                };
            }
        }
    }
