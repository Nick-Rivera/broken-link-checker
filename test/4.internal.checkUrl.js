...
describe("INTERNAL -- checkUrl", function ()
{
    ...
    {
        return checkUrl(conn.absoluteUrls[0] + "/normal/no-links.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
            .then(function (result)
            {
                expect(result).to.be.like({
                    url: {}, base: {}, http: {response: {}}, html: {}
                });
            });
    });
    ...
    describe("shall not be broken with a REAL HOST and REAL PATH from", function ()
    {
            ...
            return checkUrl(conn.absoluteUrls[0] + "/normal/no-links.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        ...
                        base: {
                            original: conn.absoluteUrls[0], resolved: conn.absoluteUrls[0] + "/"
                        },
        ...
        {
            return checkUrl(conn.relativeUrls[0] + "/normal/no-links.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        {
            return checkUrl("/normal/no-links.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        {
            return checkUrl("?query", conn.absoluteUrls[0] + "/normal/no-links.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        {
            return checkUrl("#hash", conn.absoluteUrls[0] + "/normal/no-links.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        {
            return checkUrl("", conn.absoluteUrls[0] + "/normal/no-links.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "", resolved: conn.absoluteUrls[0] + "/normal/no-links.html", redirected: null
                        },
                        base: {
                            original: conn.absoluteUrls[0] + "/normal/no-links.html",
                            resolved: conn.absoluteUrls[0] + "/normal/no-links.html"
    ...
    describe("shall be broken with a REAL HOST and FAKE PATH from", function ()
    {
        it("an absolute url", function ()
        {
            return checkUrl(conn.absoluteUrls[0] + "/normal/fake.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a scheme-relative url", function ()
        {
            return checkUrl(conn.relativeUrls[0] + "/normal/fake.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a root-path-relative url", function ()
        {
            return checkUrl("/normal/fake.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a query-relative url", function ()
        {
            return checkUrl("?query", conn.absoluteUrls[0] + "/normal/fake.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a hash-relative url", function ()
        {
            return checkUrl("#hash", conn.absoluteUrls[0] + "/normal/fake.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("an empty url", function ()
        {
            return checkUrl("", conn.absoluteUrls[0] + "/normal/fake.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "", resolved: conn.absoluteUrls[0] + "/normal/fake.html", redirected: null
                        },
                        base: {
                            original: conn.absoluteUrls[0] + "/normal/fake.html",
                            resolved: conn.absoluteUrls[0] + "/normal/fake.html"
    ...
    describe("shall be broken and have error with a FAKE HOST from", function ()
    {
        it("an absolute url", function ()
        {
            return checkUrl(conn.fakeAbsoluteUrl + "/path/to/resource.html", conn.fakeAbsoluteUrl, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                        ...
                        base: {
                            original: conn.fakeAbsoluteUrl, resolved: conn.fakeAbsoluteUrl + "/"
                        },
                        http: {response: null},
                        broken: true,
        ...
        it("a scheme-relative url", function ()
        {
            return checkUrl(conn.fakeRelativeUrl + "/path/to/resource.html", conn.fakeAbsoluteUrl, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a root-path-relative url", function ()
        {
            return checkUrl("/path/to/resource.html", conn.fakeAbsoluteUrl, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a query-relative url", function ()
        {
            return checkUrl("?query", conn.fakeAbsoluteUrl + "/path/to/resource.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("a hash-relative url", function ()
        {
            return checkUrl("#hash", conn.fakeAbsoluteUrl + "/path/to/resource.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        it("an empty url", function ()
        {
            return checkUrl("", conn.fakeAbsoluteUrl + "/path/to/resource.html", new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "", resolved: conn.fakeAbsoluteUrl + "/path/to/resource.html", redirected: null
                        },
                        base: {
                            original: conn.fakeAbsoluteUrl + "/path/to/resource.html",
                            resolved: conn.fakeAbsoluteUrl + "/path/to/resource.html"
    ...
    describe("shall be broken and have error with NO HOST from", function ()
    {
        it("an absolute url", function ()
        {
            return checkUrl("http://", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "http://", resolved: "http:///", redirected: null
                        }, base: {
                            original: null, resolved: null
                        }, http: {response: null}, broken: true, //brokenReason: "ERRNO_ECONNRESET",
                        excluded: null, excludedReason: null, internal: null, samePage: null
                    });
        ...
        it("a scheme-relative url", function ()
        {
            return checkUrl(conn.relativeUrls[0] + "/no-links.html", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: conn.relativeUrls[0] + "/no-links.html", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
        ...
        it("a root-path-relative url", function ()
        {
            return checkUrl("/normal/no-links.html", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "/normal/no-links.html", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
        ...
        it("a query-relative url", function ()
        {
            return checkUrl("?query", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "?query", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
        ...
        it("a hash-relative url", function ()
        {
            return checkUrl("#hash", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "#hash", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
        ...
        it("an empty url", function ()
        {
            return checkUrl("", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
    ...
    describe("shall be broken and have error from", function ()
    {
        ...
        {
            return checkUrl("data:image/gif;base64,R0lGODdhAQABAPAAAP///wAAACH/C1hNUCBEYXRhWE1QAz94cAAsAAAAAAEAAQAAAgJEAQA7", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
        ...
        {
            return checkUrl("tel:+5-555-555-5555", null, new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
                            original: "tel:+5-555-555-5555", resolved: null, redirected: null
                        },
                        base: {
                            original: null, resolved: null
                        },
    ...
    describe("shall not be broken with a REDIRECTED url", function ()
    {
        ...
        {
            return checkUrl(conn.absoluteUrls[0] + "/redirect/redirect.html?query", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        url: {
    ...
    describe("options", function ()
    {
        ...
        {
            return checkUrl(conn.absoluteUrls[0] + "/method-not-allowed/head.html", conn.absoluteUrls[0], new UrlCache(), helpers.options())
                .then(function (result)
                {
                    expect(result).to.be.like({
                        broken: true, brokenReason: "HTTP_405", excluded: null, excludedReason: null
                    });
                });
        });
        ...
        {
            return checkUrl(conn.absoluteUrls[0] + "/method-not-allowed/any.html", conn.absoluteUrls[0], new UrlCache(), helpers.options({requestMethod: "get"}))
                .then(function (result)
                {
                    expect(result).to.be.like({
                        broken: true, brokenReason: "HTTP_405", excluded: null, excludedReason: null
        ...
        {
            return checkUrl(conn.absoluteUrls[0] + "/method-not-allowed/head.html", conn.absoluteUrls[0], new UrlCache(), helpers.options({retry405Head: true}))
                .then(function (result)
                {
                    expect(result).to.be.like({
                        broken: false, brokenReason: null, excluded: null, excludedReason: null
                    });
                });
        });
        ...
        {
            return checkUrl(conn.absoluteUrls[0] + "/method-not-allowed/any.html", conn.absoluteUrls[0], new UrlCache(), helpers.options({retry405Head: true}))
                .then(function (result)
                {
                    expect(result).to.be.like({
                        broken: true, brokenReason: "HTTP_405", excluded: null, excludedReason: null
