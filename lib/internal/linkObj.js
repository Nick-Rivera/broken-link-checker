...
function linkObj(url)
{
    ...
    const link = {
        ...
        // Temporary keys
        broken_link_checker: true, resolved: false
    };

    // Not enumerable -- hidden from `JSON.stringify()`
    Object.defineProperty(link.base, "parsed", {value: null, writable: true});  // Same as `link.base.resolved`, but is
                                                                                // an Object
    Object.defineProperty(link.url, "parsed", {value: null, writable: true});  // Same as `link.url.resolved`, but is
                                                                               // an Object
...
linkObj.resolve = function (link, base, options)
{
    ...
    // TODO :: options.clone=true
    const resolvedUrl_parsed = urlobj.resolve(resolvedBase_parsed, cloneObject(linkOrg_parsed));
